<template>
    <div>
        <div class="row">
            <router-link to="/create-expense" class="btn btn-primary">Add Expense</router-link>
        </div>
        <div class="row mt-5">
            <div class="col-4">
                  ...
                  <table class="table align-items-center table-flush">
                    ...
                    <tbody>
                      <tr v-for="expense in searchFilter" :key="expense.id">
                        ...
                        <td>
                            <router-link :to="{name: 'edit-expense', params: {id: expense.id}}"  class="btn btn-primary">
